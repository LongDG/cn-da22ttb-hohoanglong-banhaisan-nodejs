...
// Seed dữ liệu vào database hiện tại (đã kết nối)
const seedDataToCurrentDB = async () => {
  try {
    // Kiểm tra xem đã kết nối database chưa
    if (mongoose.connection.readyState !== 1) {
      throw new Error('Database chưa được kết nối. Vui lòng chạy server trước.');
    }
...
module.exports = seedDataToCurrentDB;
